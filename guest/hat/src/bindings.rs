...
pub mod exports {
    ...
    pub mod hts {
        ...
        pub unsafe fn _export_get_temperature_cabi<T: Guest>(arg0: i32) -> *mut u8 {
            let result0 =
                T::get_temperature(super::super::wasi::i2c::i2c::I2c::from_handle(arg0 as u32));
            ...
            match result0 {
                ...
                Err(e) => {
                    *ptr1.add(0).cast::<u8>() = (1i32) as u8;
                    use super::super::wasi::i2c::i2c::ErrorCode as V3;
                    match e {
                        V3::Bus => {
        ...
        pub unsafe fn _export_get_humidity_cabi<T: Guest>(arg0: i32) -> *mut u8 {
            let result0 =
                T::get_humidity(super::super::wasi::i2c::i2c::I2c::from_handle(arg0 as u32));
            let ptr1 = _RET_AREA.0.as_mut_ptr().cast::<u8>();
            match result0 {
                Ok(e) => {
                    *ptr1.add(0).cast::<u8>() = (0i32) as u8;
  ...
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    unsafe extern "C" fn _post_return_get_humidity(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_get_humidity::<$ty>(arg0)
        ...
        #[doc(hidden)]
        pub(crate) use __export_hts_cabi;
        #[repr(align(4))]
...
macro_rules! __export_sensor_impl {
  ...
  $($path_to_types_root)*::exports::hts::__export_hts_cabi!($ty with_types_in $($path_to_types_root)*::exports::hts);
  )
}
#[doc(inline)]
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 758] = *b"\
...
\0\x03hts\x05\x03\x04\x01\x1csketch:implementation/sensor\x04\0\x0b\x0c\x01\0\x06\
sensor\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.201\
